...
df.columns = ['Ns', 'NFE', 'NFB', 'NR1','Profit']

# Save to CSV
df.to_csv('output_pandas_Direct_4D.csv', index=False, sep=';')
...
# Save to CSV
df.to_csv('output_pandas_DSDA_4D.csv', index=False, sep=';')
