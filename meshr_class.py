...
class ReactiveDistillationModel:
    ...
    def _initialize_bounds_and_scales(self):
        j, i = self.j, self.i
        # Original Bounds
        self.L.lo[j] = 1e-5;  self.L.up[j] = 50
        self.V.lo[j] = 1e-5;  self.V.up[j] = 50
        self.V.lo["1"] = 0;   self.V.up["1"] = 0.001
        self.x.lo[i, j] = 0;  self.x.up[i, j] = 1
        self.y.lo[i, j] = 0;  self.y.up[i, j] = 1
        self.D.lo[...] = 0.01;     self.D.up[...] = 1
        self.Qc.lo[...] = 0.01;    self.Qc.up[...] = 10
        self.Qr.lo[...] = 0.01;    self.Qr.up[...] = 10
        self.Breb.lo[...] = 0.001; self.Breb.up[...] = 1
        self.T.lo[j] = self.Tmin;  self.T.up[j] = self.Tmax; self.T.scale[j] = self.TF_factor
        self.FE.lo[...] = 0.00075; self.FE.up[...] = 37.43
        
        self.Tcond.lo[...] = 313.2  
        self.Treb.up[...] = 433.1  
        self.D_col.lo[j] = 0.001; self.D_col.up[j] = 2; self.D_col.scale[j] = 0.1
        self.Dcol_max.lo[...] = 0.001; self.Dcol_max.up[...] = 2

        # Mimicking GAMS Default States
        self.T.l[j] = 350
        self.Tcond.l[...] = 330
        self.Treb.l[...] = 400
        self.L.l[j] = 0.5
        ...
        self.K_part.l[i, j] = 1.0
        self.logPsat.l[i, j] = 11.5  
        self.gamma_nrtl.l[i, j] = 1.0
        self.phi.l[i, j] = 1.0
        self.alpha_ij.l[i, j] = 1.0
        self.aii.l[i, j] = 2.0
        self.a.l[j] = 2.0
        self.b.l[j] = 1e-4
        self.dadT_ii.l[i, j] = -0.005
        self.dadT.l[j] = -0.005
        self.Z.l[j] = 0.822
        self.Zvi.l[i, j] = 0.9
        self.v_mol.l[j] = 0.003
        self.v_mol_i.l[i, j] = 0.003
        self.Mw_mix.l[j] = 60.0
        self.K_eq.l[j] = 10.0
        self.k_rate.l[j] = 100.0
        self.k_A.l[j] = 10.0
        self.Rxn_Rate.l[j] = 0.0
        self.DH_ig.l[i, j] = 5000.0
        self.Hvi.l[i, j] = -150000.0
        self.Hv.l[j] = 100.0
        self.DH_liq.l[i, j] = 1000.0
        self.HR_pure.l[i, j] = -2000.0
        self.Hv_Tbi_P.l[i, j] = -150000.0
        self.Hli.l[i, j] = -180000.0
        self.Hl.l[j] = 100.0
