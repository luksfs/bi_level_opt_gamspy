...
df.columns = ['Ns', 'NFE', 'NFB', 'NR1', 'NR2', 'NR3','Profit']

# Save to CSV
df.to_csv('output_pandas_Direct_6D.csv', index=False, sep=';')
...
# Save to CSV
df.to_csv('output_pandas_DSDA_6D.csv', index=False, sep=';')
